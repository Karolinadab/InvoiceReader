...
def extract_invoice_text(pdf_path: str | Path) -> List[Dict[str, Any]]:
    """
...
if __name__ == "__main__":
    pdf_docs = extract_invoice_text("C:\\Users\\Neko\\source\\repos\\InvoiceReader\\app\\services\\invoice.pdf")
    for d in pdf_docs:
